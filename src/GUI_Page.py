...
from src.bookfinder import caputer_image,boundingBox
from tkinter import filedialog
from src.spell import correction
from src.Processing import get_grayscale,remove_noise
from src.Processing import deskew,thresholding
import numpy as np
...
root.iconbitmap(r'../Goodreads-Book-Review-Scraper/resource/icon.ico')
#GUI Screen Creator
canvas = tk.Canvas(root, height=HEIGHT, width=WIDTH)
canvas.pack()
#GUI BACKGROUND IMAGE CREATOR
background_image = tk.PhotoImage(file='../Goodreads-Book-Review-Scraper/resource/bookshelves.png')
...
cap_image='../Goodreads-Book-Review-Scraper/resource/filename.jpg'
